...
public class Amarino {
	 ...
	 * This method uses {@link DefaultAmarinoServiceIntentConfig#ACTION_CONNECT} to initiate a connection.
	 * 
	 ...
	 * <ul>
     *   <li><em>{@link DefaultAmarinoServiceIntentConfig#ACTION_CONNECTED}</em></li>
     *   <li><em>{@link DefaultAmarinoServiceIntentConfig#ACTION_DISCONNECTED}</em></li>
     *   <li><em>{@link DefaultAmarinoServiceIntentConfig#ACTION_CONNECTION_FAILED}</em></li>
     *   <li><em>{@link DefaultAmarinoServiceIntentConfig#ACTION_PAIRING_REQUESTED}</em></li>
     * </ul>
	 * 
	 ...
	 * <a href="http://developer.android.com/reference/android/content/BroadcastReceiver.html">BroadcastReceiver</a>
	 * for the {@link DefaultAmarinoServiceIntentConfig#ACTION_DISCONNECTED} intent.
	 * 
	 * @param context the context
